YAML:3:34: error: invalid boolean
AlwaysBreakTemplateDeclarations: Yes
                                 ^~~
Error reading /home/john/pcl/.clang-format: Invalid argument
...
void estimateKeypoints(const PointCloud<PointXYZ>::Ptr &src,
  ...
  // For debugging purposes only: uncomment the lines below and use pcl_viewer
  // to view the results, i.e.:
...
void computeTransformation(const PointCloud<PointXYZ>::Ptr &src,
  ...
  estimateFPFH(src, tgt, normals_src, normals_tgt, keypoints_src, keypoints_tgt,
               *fpfhs_src, *fpfhs_tgt);
